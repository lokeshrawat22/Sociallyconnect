...
export default function ChatWindow() {
  ...
  <div className="flex items-center gap-3 px-4 py-3 border-b bg-white shrink-0 ">
    ...
    {chatUser && (
      <>
        <img
          src={chatUser.profilePic || DefaultProfile}
          className="w-10 h-10 rounded-full object-cover"
        />
        <div>
          <p className="font-semibold text-gray-900">{chatUser.username}</p>
  ...
  <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 max-w-3xl mx-auto w-full no-scrollbar">
    {messages.map((msg) => (
